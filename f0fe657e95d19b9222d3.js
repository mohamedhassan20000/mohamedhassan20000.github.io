...
document.querySelectorAll('select[name="country"]').forEach(item => {
    item.addEventListener('change', () => {
        ...
        const city_options = document.getElementById('payment-cities');
...
//إخفاء و إظهار حقول إدخال البطاقة الإئتمانية 

document.querySelectorAll('#form-checkout input[name="payment-method"]').forEach(it)
